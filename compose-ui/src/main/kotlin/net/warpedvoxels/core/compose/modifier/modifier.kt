package net.warpedvoxels.core.compose.modifier
 ...
 *
 * Modifier implementations should offer a fluent factory extension public function on [Modifier] for
 ...
 * represented by the composable public function should name the parameter `modifier` and
 ...
 * desired by a composable public function should come after the `modifier` parameter's value in the
 * composable public function's implementation, keeping [Modifier] as the default parameter value.
 * For example:
 *
...
public interface Modifier {
     ...
     * the elements that appear after it. [foldIn] may be used to accumulate a value starting
     ...
     * modifier extension factory public functions:
     *
...
public class CombinedModifier(
    @PublishedApi internal val outer: Modifier,
    @PublishedApi internal val inner: Modifier
) : Modifier {
